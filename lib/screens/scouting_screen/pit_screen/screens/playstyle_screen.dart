          ...
          children: [
            SwitchColumn(
              ...
              switches: [
                SwitchField(
                  text: "Cannot Climb",
                  getValue: () => provider.prefersCoral == 1 ? 1 : 0,
                  setValue: (value) => provider.setPrefersCoral(1),
                  height: height,
                ...
                SwitchField(
                  text: "L3 Climb",
                  getValue: () => provider.preferredCoralLevel == 5 ? 1 : 0,
                  setValue: (value) => provider.setPreferredCoralLevel(5),
                  height: height,
                  bottomMargin: bottomMargin,
                ),
              ],
